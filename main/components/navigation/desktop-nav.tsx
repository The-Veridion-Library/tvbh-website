...
import { aboutLinks, aboutLinks2, contentsLinks } from "@/components/navigation/nav-links";
				...
				<NavigationMenuItem>
					...
					<NavigationMenuContent className="bg-muted/50 p-1 pr-1.5 dark:bg-background">
						...
						<div className="p-2">
							...
							Curious?{" "}
							<a className="font-medium text-foreground hover:underline" href="/subscribe">
